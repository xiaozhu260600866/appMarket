    ...
    data: {
       ...
       'tarbars': {
        ...
        'tableFields': [
            ...
            { 'prop': 'merchant_name', 'minWidth': '180', 'width': '', 'append_table_': 0, 'label': '商家名称' },
            { 'prop': 'price', 'minWidth': '', 'width': '100', 'align': 'center', 'append_table_': 0, 'label': '单价' },
            { 'prop': 'num', 'minWidth': '', 'width': '80', 'align': 'center', 'append_table_': 0, 'label': '库存' },
            { 'prop': 'fclassname', 'minWidth': '', 'width': '120', 'append_table_': 0, 'label': '分类' },
