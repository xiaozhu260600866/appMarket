			...
			<view class="upload-photoid" v-if="step == 2">
				...
				<view class="photoid">
					<view class="item" @click="uploadHeaderImg('idCard')">
						<image class="base-map img" :src="ruleform.idCard ? getSiteName + '/upload/images/deliver/'+ruleform.idCard:'https://appmarket.doxinsoft.com/images/wap/idCard-front.jpg'" ></image>
					</view>
					<view class="item" @click="uploadHeaderImg('idCard2')">
						<image class="base-map img" :src="ruleform.idCard2 ? getSiteName + '/upload/images/deliver/'+ruleform.idCard2: 'https://appmarket.doxinsoft.com/images/wap/idCard-back.jpg'"></image>
					</view>
				</view>
			...
			<view class="upload-photoid" v-if="step == 3">
				...
				<view class="photoid">
					<view class="item"  @click="uploadHeaderImg('company_logo')">
						<image class="base-map img" :src="ruleform.company_logo ? getSiteName + '/upload/images/deliver/'+ruleform.company_logo:'https://appmarket.doxinsoft.com/images/wap/business-license.jpg'"></image>
					</view>
					<view class="item"  @click="uploadHeaderImg('health_logo')">
						<image class="base-map img" :src="ruleform.health_logo ? getSiteName + '/upload/images/deliver/'+ruleform.health_logo:'https://appmarket.doxinsoft.com/images/wap/health-certificate.jpg'"></image>
					</view>
				</view>
				<view class="m20 mt40 info-subBtn">
					<dx-button block size="lg" @click="submit">完成</dx-button>
