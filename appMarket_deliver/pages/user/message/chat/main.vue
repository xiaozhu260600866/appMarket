...
<script>
	export default {
		data() {
			return {
				formAction: '/deliver/system-message?type=3&bothMessage=1',
		...
		methods: {
			add(){
				...
				this.postAjax("/deliver/addSystemMesaage",{to_userid:this.to_userid,content:this.content},"notloading").then(msg=>{
