...
<script>
	export default {
		data() {
			return {
				formAction: '/horse/system-message?type=3&bothMessage=1',
		...
		methods: {
			add(){
				...
				this.postAjax("/horse/addSystemMesaage",{to_userid:this.to_userid,content:this.content},"notloading").then(msg=>{
