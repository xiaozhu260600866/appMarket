<template>
	<view>
		...
		<view class="mt12 orderDetail">
			<view class="block-sec de-group flex-between">
				<view class="no">编号：<text class="Arial">{{ order.no }}</text></view>
			...
			<view class="block-sec de-group orderMoney">
				...
				<dx-list-cell name="支付方式" :padding="0" nameColor="#666">
					<view slot="right" class="Arial right fc-3">{{ order.send_type }}</view>
				</dx-list-cell>
